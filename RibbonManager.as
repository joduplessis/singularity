package
{
	...
	public class RibbonManager
	{
		...
		private var ribbonImage:String;
  		private var ribbons:Array;
  		private var container:Sprite;
		
		public function RibbonManager(ribbonImage:String, container:Sprite, ribbonAmount:int,ribbonParticleAmount:int,randomness:Number,imgName:String)
		{
		...
		private function init():void
		{
			...
			var imgClass:Class = getDefinitionByName(ribbonImage) as Class;
			img = new imgClass(0,0) as BitmapData;
			addRibbon();
		}
